    ...
    return (
        ...
        <div key={id} id={id} className='rounded-md pl-2 pr-2 game_card'>
            <Link href="/product/[id]" as={`/product/${gamesInfo.productSlug}`} >
                        <a>
                        <Image
                            src={gamesInfo.keyImages.map(url => ({
                                url
                            })) || '/egs_logo.png'}
                            alt={gamesInfo.title}
                            width={250}
                        ...
                        <div className="px-2 py-2">
                            <div className="font-bold text-gray-50 text-base mb-2 game_title">{gamesInfo.title}</div>
                            <div className="font-bold text-gray-400 text-sm mb-2 game_title">{gamesInfo.seller.name}</div>
                        </div>
                        </a>
                    </Link>
        </div>
