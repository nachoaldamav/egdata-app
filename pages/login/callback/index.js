...
export function useToken() {
  ...
  const callbackCode = router.query.code
  ...
  const config = {
    headers: {
      ...
      Authorization:
        "Basic eHl6YTc4OTFsY29wWnJ0ZnR4WmJ3b1NZckx0UWlOTno6VXdsQSszQTJkS2FBcHNmUGNwWkhhSlZUMXNDb09HQ1VPWW1HbHFYaWRMbw==",
    },
  }
...
export default function loginCallback({ getToken }) {
  ...
  const userInfo = axios
    .get("https://api.epicgames.dev/epic/oauth/v1/userInfo", config2)
    .then((response) => {
